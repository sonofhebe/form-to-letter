        ...
        function initMap(el) {
            var iconBase = {
                url: $("html").hasClass("dark")
                    ? "/build/assets/images/map-marker-dark.svg"
                    : "/build/assets/images/map-marker.svg",
            };
            var lightStyle = [
                {
                        ...
                        styles: [
                            {
                                ...
                                textColor: "white",
                                url: $("html").hasClass("dark")
                                    ? "/build/assets/images/map-marker-region-dark.svg"
                                    : "/build/assets/images/map-marker-region.svg",
                                anchor: [0, 0],
                            },
                        ],
                    };
