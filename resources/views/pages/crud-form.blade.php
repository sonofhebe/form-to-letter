...
@section('subcontent')
<div class="intro items-center text-center" style="margin-top: 50px;">
<i data-lucide="lock" style="width: 10% !important; height: 10% !important; display: block; margin: auto;"></i><br>
